<?php
    ...
    require_once $_SERVER['DOCUMENT_ROOT'].'/libraries/php/DomsFramework/Database/Database.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/libraries/php/DomsFramework/CMS/htmlElement.php';
    require_once $_SERVER['DOCUMENT_ROOT'].'/libraries/php/DomsFramework/CMS/form.php';
